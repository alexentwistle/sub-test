...
for domain in domains:
    ...
    subdomains = sublist3r.main(domain, 10,sublist3er_file, ports= None, silent=True, verbose= False, enable_bruteforce= False, engines=None)
    ...
    print "Found subdomains is in:", sublist3er_file
